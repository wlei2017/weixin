...
import com.example.weixin.popular.bean.card.*;
import com.example.weixin.popular.bean.card.batchget.BatchGet;
import com.example.weixin.popular.bean.card.batchget.BatchGetResult;
import com.example.weixin.popular.bean.card.code.checkcode.CodeCheckCode;
import com.example.weixin.popular.bean.card.code.checkcode.CodeCheckCodeResult;
import com.example.weixin.popular.bean.card.code.consume.CodeConsume;
import com.example.weixin.popular.bean.card.code.consume.CodeConsumeResult;
import com.example.weixin.popular.bean.card.code.decrypt.CodeDecrypt;
import com.example.weixin.popular.bean.card.code.decrypt.CodeDecryptResult;
import com.example.weixin.popular.bean.card.code.deposit.CodeDeposit;
import com.example.weixin.popular.bean.card.code.deposit.CodeDepositResult;
import com.example.weixin.popular.bean.card.code.get.CodeGet;
import com.example.weixin.popular.bean.card.code.get.CodeGetResult;
import com.example.weixin.popular.bean.card.code.getdepositcount.CodeGetDepositCount;
import com.example.weixin.popular.bean.card.code.getdepositcount.CodeGetDepositCountResult;
import com.example.weixin.popular.bean.card.code.unavailable.CodeUnavailable;
import com.example.weixin.popular.bean.card.code.update.CodeUpdate;
import com.example.weixin.popular.bean.card.create.Create;
import com.example.weixin.popular.bean.card.create.CreateResult;
import com.example.weixin.popular.bean.card.get.*;
import com.example.weixin.popular.bean.card.landingpage.create.LandingPageCreate;
import com.example.weixin.popular.bean.card.landingpage.create.LandingPageCreateResult;
import com.example.weixin.popular.bean.card.modifystock.ModifyStock;
import com.example.weixin.popular.bean.card.mpnews.gethtml.MpNewsGetHtml;
import com.example.weixin.popular.bean.card.mpnews.gethtml.MpNewsGetHtmlResult;
import com.example.weixin.popular.bean.card.paycell.set.PaySellSet;
import com.example.weixin.popular.bean.card.qrcode.create.QrCodeCreate;
import com.example.weixin.popular.bean.card.qrcode.create.QrCodeCreateMultiple;
import com.example.weixin.popular.bean.card.qrcode.create.QrCodeCreateResult;
import com.example.weixin.popular.bean.card.testwhitelist.set.TestWhiteListSet;
import com.example.weixin.popular.bean.card.update.*;
import com.example.weixin.popular.bean.card.user.getcardlist.UserGetCardList;
import com.example.weixin.popular.bean.card.user.getcardlist.UserGetCardListResult;
