...
import com.example.weixin.popular.bean.bizwifi.apportal.ApportalRegister;
import com.example.weixin.popular.bean.bizwifi.apportal.ApportalRegisterResult;
import com.example.weixin.popular.bean.bizwifi.bar.BarSet;
import com.example.weixin.popular.bean.bizwifi.base.ShopInfo;
import com.example.weixin.popular.bean.bizwifi.couponput.get.CouponputGetResult;
import com.example.weixin.popular.bean.bizwifi.couponput.set.CouponputSet;
import com.example.weixin.popular.bean.bizwifi.device.delete.DeviceDelete;
import com.example.weixin.popular.bean.bizwifi.device.list.DeviceList;
import com.example.weixin.popular.bean.bizwifi.device.list.DeviceListResult;
import com.example.weixin.popular.bean.bizwifi.finishpage.FinishPageSet;
import com.example.weixin.popular.bean.bizwifi.homepage.get.HomePageGetResult;
import com.example.weixin.popular.bean.bizwifi.homepage.set.HomePageSet;
import com.example.weixin.popular.bean.bizwifi.openplugin.OpenPluginToken;
import com.example.weixin.popular.bean.bizwifi.openplugin.OpenPluginTokenResult;
import com.example.weixin.popular.bean.bizwifi.qrcode.QrcodeGet;
import com.example.weixin.popular.bean.bizwifi.qrcode.QrcodeGetResult;
import com.example.weixin.popular.bean.bizwifi.shop.get.ShopGetResult;
import com.example.weixin.popular.bean.bizwifi.shop.list.ShopList;
import com.example.weixin.popular.bean.bizwifi.shop.list.ShopListResult;
import com.example.weixin.popular.bean.bizwifi.shop.update.ShopUpdate;
import com.example.weixin.popular.bean.bizwifi.statistics.StatisticsList;
import com.example.weixin.popular.bean.bizwifi.statistics.StatisticsListResult;
