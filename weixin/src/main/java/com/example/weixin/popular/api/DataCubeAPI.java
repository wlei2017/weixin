...
import com.example.weixin.popular.bean.datacube.article.ArticlesummaryResult;
import com.example.weixin.popular.bean.datacube.article.ArticletotalResult;
import com.example.weixin.popular.bean.datacube.article.UserreadResult;
import com.example.weixin.popular.bean.datacube.article.UsershareResult;
import com.example.weixin.popular.bean.datacube.getcardbizuininfo.BizuinInfo;
import com.example.weixin.popular.bean.datacube.getcardbizuininfo.BizuinInfoResult;
import com.example.weixin.popular.bean.datacube.getcardcardinfo.CardInfo;
import com.example.weixin.popular.bean.datacube.getcardcardinfo.CardInfoResult;
import com.example.weixin.popular.bean.datacube.getcardmembercardinfo.MemberCardInfo;
import com.example.weixin.popular.bean.datacube.getcardmembercardinfo.MemberCardInfoResult;
import com.example.weixin.popular.bean.datacube.interfaces.InterfacesummaryResult;
import com.example.weixin.popular.bean.datacube.upstreammsg.UpstreammsgResult;
import com.example.weixin.popular.bean.datacube.user.UsercumulateResult;
import com.example.weixin.popular.bean.datacube.user.UsersummaryResult;
import com.example.weixin.popular.bean.datacube.wxapp.*;
